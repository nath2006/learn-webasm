...
var _accumulate = Module['_accumulate'] = makeInvalidEarlyAccess('_accumulate');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['accumulate'] != 'undefined', 'missing Wasm export: accumulate');
  ...
  _accumulate = Module['_accumulate'] = createExportWrapper('accumulate', 2);
